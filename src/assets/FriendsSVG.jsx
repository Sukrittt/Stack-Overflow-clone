...
export default function FriendSvg() {
  useEffect(() => {
    ...
    timeline
      .fromTo(
        ".friend-svg",
        { y: -10 },
        { y: 0, yoyo: true, repeat: -1, duration: 1.25 }
      )
      .fromTo(
        ".friend-list",
        {
  ...
  return (
    ...
    >
      ...
      <g data-name="Group 76">
        ...
        />
        <circle cx="152.605" cy="526.628" fill="#ffb8b8" r="17.5" />
      </g>
      ...
      <circle cx="522.105" cy="564.128" fill="#ffb8b8" r="16" />
    </svg>
  );
}
